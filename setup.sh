...
echo ""
echo "Commands:"
echo "  context list                        - List all sessions"
echo "  context analyze <session-id>        - Analyze a session"
echo "  context manage <session-id> <model> - Edit session interactively"
echo "  context checkpoint <id> <name>      - Backup a session"
echo "  context delete <session-id>         - Remove a session"
echo "  context dump <session-id> [type]    - View raw session data"
echo "  context help                        - Show detailed help"
echo ""
