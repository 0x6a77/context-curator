...
function main() {
  ...
  console.log('     npm --prefix ~/.claude/skills/context-curator run init');
  console.log('     npm --prefix ~/.claude/skills/context-curator run context list');
  console.log('');
  console.log('  3. Common workflow:');
  console.log('     • "context list" - see sessions for current project');
