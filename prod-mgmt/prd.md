...
| T-INST-5 | After `install.sh`, every SKILL.md in the authoring, session, and monitor bundles exists at `~/.claude/commands/<bundle>/<skill-name>.md` |
