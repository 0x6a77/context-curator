...
**CLAUDE.md, project root** → [Reference: the two-file system](reference.md#the-two-file-claudemd-system)

**CLAUDE.md, task-specific** → [Reference: task CLAUDE.md files](reference.md#task-claudemd-files)

**CLAUDE.md, two-file system** → [Reference: the two-file CLAUDE.md system](reference.md#the-two-file-claudemd-system)
...
**compaction, auto-save before** → [Hooks and Automation: PreCompact auto-save hook](hooks-automation.md#precompact-auto-save-hook)

**compaction, context re-injection after** → [Hooks and Automation: PostCompact task re-injection hook](hooks-automation.md#postcompact-task-re-injection-hook)

**conflicts, no git** → [Security: no git conflicts](security.md#no-git-conflicts)
...
**git footprint** → [Security: git footprint](security.md#git-footprint)

**gitignore, .claude/.gitignore** → [Reference: the two-file system](reference.md#the-two-file-claudemd-system) | [Security: git footprint](security.md#git-footprint)
...
**keys, AWS** → [Security: what gets detected](security.md#what-gets-detected)

**keys, GitHub tokens** → [Security: what gets detected](security.md#what-gets-detected)

**keys, RSA private** → [Security: what gets detected](security.md#what-gets-detected)
...
**path handling** → [Reference: cross-platform compatibility](reference.md#cross-platform-compatibility)

**permuted index** → [Permuted Index](permuted-index.md) | [Glossary: permuted index](glossary.md#permuted-index)
