...
This file governs the visual design and layout of all HTML documentation generated by `/docs-html`. Claude reads this file before generating any HTML output. When generating pages, produce a shared `docs/html/assets/style.css` and `docs/html/assets/main.js` that all pages link to — do not inline styles or scripts per-page.
